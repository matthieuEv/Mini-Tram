...
public class ProgressionHandler extends Thread {
    ...
    public ProgressionHandler() {
        ...
        LineStation.getInstance().resetAll();
        LineTram.getInstance().resetAll();
        StationPeople.getInstance().resetAll();
        TramPeople.getInstance().resetAll();
        TramStation.getInstance().resetAll();
